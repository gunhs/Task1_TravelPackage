...
public class ServiceFactory {
    ...
    public static void processing(int command) {
        switch (command) {
            ...
            default -> System.out.println("Неверный номер команды. Введите команду от 1 до 6");
        }
    }
    ...
    private static void addTour() {
        ...
        System.out.println(travelPackages.addTour(components[0].trim(), new Tour(components[0].trim(),
    ...
    private static void bayTour() {
        ...
        System.out.println(travelPackages.bayTour(components2[0].trim(), new Voucher(components2[1].trim(),
    ...
    private static void cancelTour() {
        ...
        System.out.println(travelPackages.cancelTour(components3[0].trim(), components3[1].trim()));
    }
    ...
    private static void getVoucherByTour() {
        ...
        System.out.println(travelPackages.getVoucher(input4));
    }

    private static void getVoucherCount() {
        System.out.println("Введите название тура");
        String input5 = new Scanner(System.in).nextLine().trim();
        System.out.println(travelPackages.getInformation(input5));
    }
